...
export default function Project() {
    return (
        <div className="relative overflow-hidden py-10 bg-gray-100" id="projects">
            {/* Background elements */}
            <div className="absolute inset-0 z-0 mt-32 -ml-[7vh] bg-black w-[18rem] h-[18rem] rounded-full"></div>
            <div className="absolute inset-0 z-0 mt-96 ml-[calc(100vw-8rem)] bg-purple-800 w-[30rem] h-[30rem] rounded-full"></div>
            <div className="absolute z-0 flex items-center justify-center h-screen">
                ...
                >
                    <path
                        ...
                        stroke="black"
                        strokeWidth="20"
                        d="M0,300 C40,300 1000,-90 1440,60"
                    ></path>
                </svg>
            </div>
                ...
                <div className="flex flex-col -mt-14 justify-center items-center w-full h-[100vh] backdrop-blur-md bg-white bg-opacity-70">
                    ...
                    >
                        ...
                        <SwiperSlide className="!w-fit">
                            <div className="flex flex-col items-center justify-center w-[90vw] md:w-[60vw] lg:w-[50vw] xl:w-[35vw] h-[60vh] md:h-[50vh] lg:h-[60vh] bg-purple-100 shadow-lg rounded-xl p-4">
                                <img 
                                    src="project1.png" 
                                    alt="Project 1" 
